...
import static com.b0ve.cmepps.ahorcado.ControladorJuego.ESTADOS.*;
...
public class ControladorJuego implements KeyListener {
    ...
    private final StringBuilder palabraTMP;
    ...
    private void adivinarLetra(char letra) {
        ...
        if (letra != '\b' && letra != ' ' && letra != '\r' && letra != '\n') {
            ...
            if (canvas.isAdivinada() || canvas.getLineas() >= CanvasAhorcado.TOTAL_LINES) {
